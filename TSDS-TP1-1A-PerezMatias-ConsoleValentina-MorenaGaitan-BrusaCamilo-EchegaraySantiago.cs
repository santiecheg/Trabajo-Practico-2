...
class ProgramaTp{
        ...
        do {
           ...
           "Mejor vuelta registrada: " + mejorVuelta + "s");  
            ...
            case 3:
                ...
                for (int i = 3; i > 0; i--) // le saqué el '=' para que se hagan 3 ciclos
                {
           ...
           if (control==true) {
            ...
            if (validacionContrsena==true) {
                ...
                Console.WriteLine ("Ingrese ahora su usuario");
    ...
    {
        if (contraseña == null) return false; //Ve q no este vacia
